...
class DetailViewController: UIViewController {
    ...
    @IBAction func testButton(sender: UIButton) {
        ...
        //Gets the URL of recorded heartbeat
        let url: NSURL = {
        ...
        //CHANGE THIS TO THE URL OF RECORDED SOUND
        let path1 = NSBundle.mainBundle().pathForResource("Apex Supine Split S1", ofType: "caf")
                                        ...
                                        {(alertController: UIAlertAction!)->Void in
                                            ...
                                            dispatch_async(dispatch_get_main_queue(), {() -> Void in
                                                ...
                                                if let str = sequenceSupine as? String {
                                                    ...
                                                    LBAudioDetectiveCompareAudioURLs(detective, url, sequenceURL, 0, &match)
                                                    print("Match =  \(match)")
 ...
 */
       ...
       print("Comparing normal vs innocent signal")
        ...
        let path2 = NSBundle.mainBundle().pathForResource("Apex Supine Split S1", ofType: "caf")
 ...
 */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "Output" {
            ...
            //outputViewController.compareHeartbeat(url)
        }
    }
